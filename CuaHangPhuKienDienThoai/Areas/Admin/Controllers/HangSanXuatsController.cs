...
namespace CuaHangPhuKienDienThoai.Areas.Admin.Controllers
{
    public class HangSanXuatsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,TenHang,HinhAnh,IsActive")] HangSanXuat hangSanXuat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,TenHang,HinhAnh,IsActive")] HangSanXuat hangSanXuat)
        {
            if (ModelState.IsValid)
            {
