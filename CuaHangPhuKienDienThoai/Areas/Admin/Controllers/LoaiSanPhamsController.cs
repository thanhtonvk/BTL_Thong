...
namespace CuaHangPhuKienDienThoai.Areas.Admin.Controllers
{
    public class LoaiSanPhamsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,TenLoai,HinhAnh,IsActive")] LoaiSanPham loaiSanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,TenLoai,HinhAnh,IsActive")] LoaiSanPham loaiSanPham)
        {
            if (ModelState.IsValid)
            {
